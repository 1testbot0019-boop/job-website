...
-- Secure authentication audit trail. Never store passwords here.
...
create index if not exists auth_activity_user_id_created_at_idx on public.auth_activity(user_id, created_at desc);
