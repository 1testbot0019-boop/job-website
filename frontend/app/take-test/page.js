...
export default function TakeTestPage() {
  ...
  const startTest = (id = category) => {
    setCategory(id);
    setQuestions(getQuestions(id, id === "mixed" ? MIXED_SIZE : SUBJECT_SIZE));
    setAnswers({}); setCurrent(0); setSeconds(TEST_TIME); setSubmitted(false); setStarted(true);
  };
